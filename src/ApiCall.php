...
/**
 * Class for emulate work with API
 *
 * Class ApiCall
 * @package Language
 */
...
return [
    ...
    'woman'             => 'Frau'
        ...
        GET_APPLET_LANGUAGE_FILE_RESULT = '<?xml version="1.0" encoding="UTF-8"?>
<data>
     ...
     * @return array|void
     */
    public static function call(string $target, string $mode, array $getParameters, array $postParameters)
    {
     ...
     * @return array
     */
    private static function formatAsResult($data): array
    {
        return [
            'status' => 'OK',
            'data'   => $data,
